...
> Generated at: 2026-03-15T04:38:21.799Z
...
- Source files (.ts/.tsx under src): 129
- Unit tests: 12
- Integration tests: 0
- E2E tests: 3
...
- .eslintrc.json
- .github/agents/edunexus-engineer.agent.md
- .github/copilot-instructions.md
- .github/hooks/context-sync.json
- .github/instructions/edunexus-context.instructions.md
- .github/prompts/build-test-enhance.prompt.md
- .github/prompts/sync-context.prompt.md
- Documentation/AI_CONTEXT_SNAPSHOT.md
- Documentation/ANTIGRAVITY_UI_PROMPT_PHASE2_1_2.md
- Documentation/PROGRESS.md
- package.json
- pnpm-lock.yaml
...
- src/emails/
- src/lib/email.ts
- supabase/migrations/20260315000002_create_notification_logs.sql
- test_auth.ts
