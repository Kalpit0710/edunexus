...
> Generated at: 2026-07-03T12:02:44.089Z
...
- Source files (.ts/.tsx under src): 265
- Unit tests: 22
- Integration tests: 4
- E2E tests: 7
...
- Documentation/TESTING_STRATEGY.md
- Documentation/UI_UX_GUIDELINES.md
- Documentation/modules/01_school_configuration.md
- Documentation/modules/02_student_management.md
- Documentation/modules/03_teacher_management.md
- Documentation/modules/04_attendance.md
...
- Documentation/modules/08_communication.md
- Documentation/modules/09_dashboard_reports.md
- Documentation/modules/10_parent_portal.md
- Documentation/modules/11_super_admin.md
- Documentation/phases/phase1_mvp.md
- Documentation/phases/phase2_advanced.md
- Documentation/phases/phase3_scalability.md
- Documentation/phases/phase4_mobile.md
- scripts/sync-ai-context.js
- src/app/(parent)/parent/actions.ts
- src/app/(parent)/parent/announcements/page.tsx
...
- src/app/(manager)/manager/notifications/
- src/app/(school-admin)/school-admin/homework/
- src/app/(super-admin)/super-admin/notifications/
- src/app/(teacher)/teacher/notifications/
- src/lib/announcement-utils.ts
- src/lib/super-admin-notification-utils.ts
- supabase/migrations/20260703000001_announcements_module.sql
- tests/unit/lib/announcement-utils.test.ts
- tests/unit/lib/super-admin-notification-utils.test.ts
