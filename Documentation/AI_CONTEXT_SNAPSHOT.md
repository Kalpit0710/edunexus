...
> Generated at: 2026-07-13T10:11:53.724Z
...
- Source files (.ts/.tsx under src): 292
- Unit tests: 22
- Integration tests: 5
- E2E tests: 7
...
- pnpm docs:check-freshness: node scripts/check-doc-freshness.mjs
...
- Modified/untracked files: 25
- Documentation/AI_CONTEXT_SNAPSHOT.md
- Documentation/PROGRESS.md
- src/app/(manager)/manager/inventory/actions.ts
- src/app/(manager)/manager/inventory/page.tsx
- src/app/(manager)/manager/inventory/procurement/page.tsx
- src/app/(manager)/manager/inventory/reports/page.tsx
- src/app/(manager)/manager/inventory/sale-controls/page.tsx
- src/app/(parent)/parent/actions.ts
- src/app/(parent)/parent/fees/page.tsx
- src/app/(school-admin)/school-admin/fees/actions.ts
- src/app/(school-admin)/school-admin/fees/adjustments/page.tsx
- src/app/(school-admin)/school-admin/fees/page.tsx
- src/app/(school-admin)/school-admin/fees/recovery/page.tsx
- src/components/manager-sidebar.tsx
- src/components/school-admin-sidebar.tsx
- src/lib/fees/balance.ts
- src/types/database.types.ts
- supabase/migrations/20260709000002_fee_recovery_adjustment_workflows.sql
- supabase/migrations/20260709000003_inventory_sale_control_workflow.sql
- supabase/migrations/20260709000004_inventory_procurement_and_audit.sql
- supabase/migrations/20260709000005_inventory_sales_updated_at_hotfix.sql
- supabase/migrations/20260709000006_inventory_suppliers_po_approval.sql
- tests/e2e/inventory.spec.ts
- tests/integration/inventory-sale-control-lifecycle.test.ts
- tests/unit/inventory/inventory-ui-flows.test.tsx
