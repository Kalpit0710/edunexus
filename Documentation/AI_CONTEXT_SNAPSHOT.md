...
> Generated at: 2026-07-07T09:42:41.233Z
...
```mermaid
flowchart LR
  SourceDocs[Source Documentation] --> Snapshot[AI Context Snapshot]
  Snapshot --> AgentUse[AI Assistant Context]
  AgentUse --> RepoChanges[Code or Doc Updates]
  RepoChanges --> RefreshSync[Context Sync]
  RefreshSync --> Snapshot
```
...
- Source files (.ts/.tsx under src): 275
- Unit tests: 22
- Integration tests: 4
- E2E tests: 7
...
- src/app/(manager)/manager/notifications/actions.ts
...
- src/app/(school-admin)/school-admin/calendar/actions.ts
- src/app/(school-admin)/school-admin/dashboard/actions.ts
- src/app/(school-admin)/school-admin/dashboard/page.tsx
- src/app/(school-admin)/school-admin/fees/actions.ts
- src/app/(school-admin)/school-admin/fees/collect/page.tsx
- src/app/(school-admin)/school-admin/homework/actions.ts
- src/app/(school-admin)/school-admin/library/actions.ts
- src/app/(school-admin)/school-admin/promotion/actions.ts
- src/app/(school-admin)/school-admin/promotion/page.tsx
- src/app/(school-admin)/school-admin/report-cards/actions.ts
...
- src/app/(school-admin)/school-admin/transport/actions.ts
- src/app/(super-admin)/super-admin/actions.ts
- src/app/(super-admin)/super-admin/notifications/actions.ts
- src/app/(teacher)/teacher/attendance/actions.ts
- src/app/(teacher)/teacher/dashboard/actions.ts
- src/app/(teacher)/teacher/homework/actions.ts
- src/app/(teacher)/teacher/notifications/actions.ts
- src/app/(teacher)/teacher/timetable/actions.ts
- src/components/app-initializer.tsx
- src/components/manager-sidebar.tsx
- src/components/modules/report-cards/StudentMarksEditor.tsx
- src/components/parent-sidebar.tsx
- src/components/school-admin-sidebar.tsx
- src/components/teacher-sidebar.tsx
- src/lib/fees/balance.ts
- src/lib/supabase/middleware.ts
- src/styles/globals.css
- src/types/database.types.ts
- src/app/(manager)/manager/qr-scan/
- src/app/(school-admin)/school-admin/id-cards/
- src/app/(school-admin)/school-admin/qr-scan/
- src/app/(teacher)/teacher/qr-scan/
