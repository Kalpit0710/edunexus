...
> Generated at: 2026-07-01T11:51:16.359Z
...
- Source files (.ts/.tsx under src): 249
- Unit tests: 20
- Integration tests: 4
- E2E tests: 7
...
- Modified/untracked files: 51
- .env.example
- Documentation/AI_CONTEXT_SNAPSHOT.md
- Documentation/PRODUCT_BACKLOG.md
- Documentation/PROGRESS.md
- Documentation/modules/06_fee_billing_pos.md
- Documentation/modules/07_bookstore_inventory.md
...
- src/components/modules/report-cards/ReportCardDocument.tsx
- src/components/school-admin-sidebar.tsx
- src/lib/email.ts
- src/lib/fee-utils.ts
- src/lib/supabase/middleware.ts
- src/types/database.types.ts
- tests/unit/fees/fee-utils.test.ts
- src/app/(auth)/register-school/
- src/app/(manager)/manager/inventory/import/
- src/app/(school-admin)/school-admin/fees/reminder-actions.ts
- src/app/api/auth/school-register/
- src/app/api/cron/fee-reminders/
- src/app/api/debug/
- src/components/live-search.tsx
- src/components/school-area-sidebar.tsx
- src/hooks/use-debounced-value.ts
- src/lib/fee-reminder-utils.ts
- src/lib/school-onboarding.ts
- supabase/migrations/20260625000001_photo_storage.sql
- supabase/migrations/20260701000001_inventory_class_link.sql
- supabase/migrations/20260701000002_manager_manage_students_rls.sql
- supabase/migrations/20260701000003_link_existing_book_items_to_class.sql
- tests/unit/lib/fee-reminder-utils.test.ts
