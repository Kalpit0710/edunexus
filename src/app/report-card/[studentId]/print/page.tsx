...
/** 8-point CBSE grade scale shown in the instructions legend (matches SRMS). */
...
const SHARED_CSS = `
  ...
  .srms-toolbar { max-width: 820px; margin: 0 auto 12px; display: flex; justify-content: flex-end; padding: 0 12px; }
  .srms-print-btn {
...
const STANDARD_CSS =
  SHARED_CSS +
  `
  .srms-page { max-width: 820px; margin: 0 auto; background: #fff; color: #111; font-family: Arial, Helvetica, sans-serif; border: 2px solid #1a3a5c; box-shadow: 0 10px 40px rgba(0,0,0,0.12); }
...
const LOWER_CSS =
  SHARED_CSS +
  `
  .srms-page { max-width: 820px; margin: 0 auto; background: #fff; color: #111; font-family: Arial, Helvetica, sans-serif; border: 2px solid #a32a2a; box-shadow: 0 10px 40px rgba(0,0,0,0.12); }
