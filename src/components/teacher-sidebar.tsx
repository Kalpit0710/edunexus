        ...
        <aside className="flex h-screen w-64 shrink-0 flex-col border-r border-white/[0.06] bg-[#0a0a0a]">
            ...
            <div className="flex items-center gap-3 border-b border-white/[0.06] px-5 py-4">
                ...
                <div className="min-w-0">
                    ...
                    <p className="text-xs text-zinc-500">Teacher Portal</p>
                </div>
            </div>

            {/* Nav */}
            <nav aria-label="Teacher navigation" className="flex-1 overflow-y-auto px-3 py-4 space-y-0.5 scrollbar-hide">
