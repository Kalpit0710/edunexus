...
export function FullPageLoader({ label = 'Loading, please wait...' }: LoaderProps) {
  return (
    <div
      ...
      aria-live="polite"
      aria-label={label}
      className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0a0a0a] p-4"
    >
      ...
      <div className="relative z-10 w-full max-w-sm rounded-3xl border border-white/[0.08] bg-white/[0.03] p-8 text-center backdrop-blur-xl">
        <div className="mb-3 inline-flex h-12 w-12 items-center justify-center rounded-2xl border border-blue-500/30 bg-blue-600/10" aria-hidden="true">
    ...
    >
      <div className="w-full max-w-3xl rounded-3xl border border-white/[0.08] bg-white/[0.03] p-6 backdrop-blur-xl">
        <div className="mb-5 flex items-center gap-3">
          <div className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-blue-500/30 bg-blue-600/10" aria-hidden="true">
